/**
 * Media test: real browsers publishing fake devices, asserting RTP arrives.
 *
 ...
 *
 * The browser plumbing lives in ./harness.mjs, shared with ui.test.mjs and meeting.test.mjs.
 */
...
// Bound to locals so every case below reads exactly as it did when these lived in this file.
...
const capabilitySeconds = (...args) => harness.capabilitySeconds(...args);
